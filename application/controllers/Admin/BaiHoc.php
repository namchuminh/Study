...
class BaiHoc extends CI_Controller {
	...
	public function add()
	{
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$mabaihoc = $this->Model_BaiHoc->add($tenbaihoc,$mota,$duongdan,$magiaovien,$loaibaihoc,$matrinhdo);
	...
	public function update($mabaihoc)
	{
		...
		if ($this->input->server('REQUEST_METHOD') === 'POST') {
			...
			$this->Model_BaiHoc->update($tenbaihoc,$mota,$duongdan,$magiaovien,$loaibaihoc,$matrinhdo,$mabaihoc);
